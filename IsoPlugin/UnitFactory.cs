...
namespace AgGateway.ADAPT.IsoPlugin
{
    internal class UnitFactory
    {
        ...
        static readonly Dictionary<UnitOfMeasureDimensionEnum, int> _dimensionToDdi =
        ...
        {
            if (_dimensionToDdi.ContainsKey(dimension))
                return GetUnitByDdi(_dimensionToDdi[dimension]);
