...
namespace AgGateway.ADAPT.Plugins
{
    internal class UnitFactory
    {
        ...
        private UnitFactory()
        {
            _units[new Interval { min = 1, max = 5 }] = new IsoUnit("l[ha]-1", 0.0001, 0);
            _units[new Interval { min = 6, max = 10 }] = new IsoUnit("kg[ha]-1", 0.01, 0);
            _units[new Interval { min = 11, max = 15 }] = new IsoUnit("count[m2]-1", 0.001, 0);     //0x0B - 0x0F
            _units[new Interval { min = 16, max = 20 }] = new IsoUnit("m", 0.001, 0);               //0x10 - 0x14
            _units[new Interval { min = 21, max = 25 }] = new IsoUnit("ml[m3]-1", 0.001, 0);        //0x15 - 0x19
            _units[new Interval { min = 26, max = 30 }] = new IsoUnit("g[kg]-1", 0.001, 0);         //0x1A - 0x1E
            _units[new Interval { min = 31, max = 35 }] = new IsoUnit("ml[kg]-1", 0.001, 0);        //0x1F - 0x23
            _units[new Interval { min = 36, max = 40 }] = new IsoUnit("ml[sec]-1", 0.001, 0);       //0x24 - 0x28
            _units[new Interval { min = 41, max = 45 }] = new IsoUnit("g[sec]-1", 0.001, 0);        //0x29 - 0x2D
            _units[new Interval { min = 46, max = 50 }] = new IsoUnit("count[s]-1", 0.001, 0);      //0x2E - 0x32
            ...
            _units[new Interval { min = 83, max = 83 }] = new IsoUnit("ml[m2]-1", 1, 0);            //0x53
            _units[new Interval { min = 84, max = 84 }] = new IsoUnit("kg[ha]-1", 0.01, 0);         //0x54
            _units[new Interval { min = 85, max = 85 }] = new IsoUnit("count[m2]-1", 0.001, 0);     //0x55
            _units[new Interval { min = 86, max = 86 }] = new IsoUnit("ml[sec]-1", 1, 0);           //0x56
            _units[new Interval { min = 87, max = 87 }] = new IsoUnit("kg[hr]-1", 0.0036, 0);       //0x57
            _units[new Interval { min = 88, max = 88 }] = new IsoUnit("count[sec]-1", 0.001, 0);    //0x58
            ...
            _units[new Interval { min = 92, max = 92 }] = new IsoUnit("ml[m2]-1", 1, 0);            //0x5C
            _units[new Interval { min = 93, max = 93 }] = new IsoUnit("kg[ha]-1", 0.01, 0);         //0x5D
            _units[new Interval { min = 94, max = 94 }] = new IsoUnit("count[m2]-1", 0.001, 0);     //0x5E
            _units[new Interval { min = 95, max = 95 }] = new IsoUnit("ml[sec]-1", 1, 0);           //0x5F
            _units[new Interval { min = 96, max = 96 }] = new IsoUnit("kg[hr]-1", 0.0036, 0);       //0x60
            _units[new Interval { min = 97, max = 97 }] = new IsoUnit("count[sec]-1", 0.001, 0);    //0x61
            ...
            _units[new Interval { min = 121, max = 121 }] = new IsoUnit("g[l]-1", 1, 0);            //0x79
            _units[new Interval { min = 122, max = 122 }] = new IsoUnit("g[count]-1", 1, 0);        //0x7A
            _units[new Interval { min = 123, max = 123 }] = new IsoUnit("ml[count]-1", 0.001, 0);   //0x7B
            ...
            _units[new Interval { min = 149, max = 149 }] = new IsoUnit("l[hr]-1", 0.0036, 0);      //0x95
            _units[new Interval { min = 150, max = 150 }] = new IsoUnit("l[ha]-1", 0.01, 0);        //0x96
            _units[new Interval { min = 151, max = 151 }] = new IsoUnit("cm2[sec]-1", 0.01, 0);     //0x97
            _units[new Interval { min = 152, max = 152 }] = new IsoUnit("ml[m3]-1", 0.00001, 0);    //0x98
        }
